...
time.sleep(2)
# conectamos el monitor serial

# Se creo una fucion para calcular el centro de la mano
...
with mp_hands.Hands(
    ...
    while True:
        ...
        if results.multi_hand_landmarks:
            # se generan los arrays donde se van a almacenar los datos de los dedos
            coordinates_thumb = []
            coordinates_palm = []
            coordinates_ft = []
            coordinates_fb = []
